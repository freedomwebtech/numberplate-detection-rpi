...
area = [(1, 485), (1, 542), (799,532),(798, 477)]
def save_to_text(number_plate, timestamp):
    text_filename = os.path.join(output_folder, 'numberplates.txt')
    with open(text_filename, 'a') as f:
...
while True:
    ...
    for index, row in px.iterrows():
        ...
        if result >= 0:
           ...
           text = pytesseract.image_to_string(gray, config='-l eng --psm 11 -c tessedit_char_whitelist=ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890')
